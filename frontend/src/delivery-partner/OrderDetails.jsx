      ...
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-xl p-6">
        ...
        <div className="mt-6">
          ...
          <div className="flex gap-3 flex-wrap">
            <button disabled={order?.status==="Ready to Pickup"?false:true}  onClick={()=>handleUpdateOrder("Out for Delivery")} className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition  disabled:bg-gray-400 disabled:cursor-not-allowed">
              Out for Delivery
            </button>
            <button disabled={order?.status==="Out for Delivery"?false:true} onClick={()=>handleUpdateOrder("Delivered")} className="px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition disabled:bg-gray-400 disabled:cursor-not-allowed">
              Delivered
            </button>
            ...
            <button disabled={order?.status==="Delivered" ||order?.status==="Cancelled" ?true:false} onClick={()=>handleUpdateOrder("Cancelled")} className="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition disabled:bg-gray-400 disabled:cursor-not-allowed">
              Cancel Order
            </button>
          </div>
        </div>
