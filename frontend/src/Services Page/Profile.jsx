...
function Profile() {
  ...
  return (
    <div className='relative z-100'>
      <div onClick={()=>setShowProfile(!showProfile)} className='w-8 relative cursor-pointer flex justify-center items-center'>
      ...
      <div className={`${showProfile?"":"hidden"} bg-white rounded shadow-md border border-gray-200 w-40 p-2 absolute top-10 right-0`}>
